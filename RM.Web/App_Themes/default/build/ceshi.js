...
(function (undefined) {
    ...
    Kalendae.prototype = {
        defaults: {
            ...
            direction: 'today-future',           /* past, today-past, any, today-future, future */
            ...
            titleFormat: 'YYYY年MMMM月',    /* format mask for month titles. See momentjs.com for rules */
        ...
        draw: function draw() {
            ...
            do {
                ...
                do {
                    ...
                    var spanHtml = day.format(opts.dayNumberFormat);
                    if (s) {
                    ...
                    if (day.startOf('day').yearDay() === today.yearDay()) {
                    ...
                    if (day.startOf('day').yearDay() < today.yearDay() || day.month() != month.month()) {
                        klass = [];
                        klass.push("k-out-of-month");
                        if ((j / 7) >= 5) {
                            if (j == 35 && day.month() != month.month()) {
                                nm = true;
                            }
                            if (nm) {
                                //klass.push(" NextMonth");
    ...
    */
    ...
    today = Kalendae.moment(new Date(new Date().getTime() - 6 * 60 * 60 * 1000)).startOf('day');
