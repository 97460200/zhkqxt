...
namespace RM.Web.Lib
{
    ...
    public class HttpService
    {
        ...
        public static string PostOwn(string xml, string url, bool isUseCert, int timeout, string AdminHotelid, int Hotelid)
        {
            System.GC.Collect();//垃圾回收，回收没有正常关闭的http连接
            ...
            try
            {
                ...
                * ************************************************************/
                ...
                if (isUseCert)
                {
                    ...
                    //将上面的改成
                    X509Certificate2 cert = new X509Certificate2(path + WxPayConfig.sslcert_path_own(AdminHotelid, Hotelid), WxPayConfig.sslcert_password_own(AdminHotelid, Hotelid), X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.MachineKeySet);//线上发布需要添加
