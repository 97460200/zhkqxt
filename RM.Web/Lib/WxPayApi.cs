...
namespace RM.Web.Lib
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, string AdminHotelid, int Hotelid, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(xml, url, false, timeOut, AdminHotelid, Hotelid);//调用HTTP通信接口提交数据
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, string AdminHotelid, int Hotelid = 0, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(xml, url, true, timeOut, AdminHotelid, Hotelid);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, string AdminHotelid, int Hotelid = 0, int timeOut = 6)
        {
       ...
       */
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, string AdminHotelid, int Hotelid = 0, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, string AdminHotelid, int Hotelid = 0, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData CloseOrder(WxPayData inputObj, string AdminHotelid, int Hotelid = 0, int timeOut = 6)
        {
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj, string AdminHotelid, int Hotelid = 0)
        {
            //如果不需要进行上报
