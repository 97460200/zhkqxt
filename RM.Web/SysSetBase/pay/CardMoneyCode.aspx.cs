...
{
    public partial class CardMoneyCode : System.Web.UI.Page
    {
        ...
        private void Bind()
        {
            ...
            sb.Append("SELECT a.CardMoneyCode,b.CentreLogo FROM dbo.Hotel_AdminParameter a LEFT JOIN dbo.Hotel_Admin b ON a.AdminHotelId = b.AdminHotelid WHERE a.AdminHotelId = @AdminHotelId");
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                {
                    imgPledgeMoneyCode.Src = dt.Rows[0]["CardMoneyCode"].ToString();
                }
                else
                {
