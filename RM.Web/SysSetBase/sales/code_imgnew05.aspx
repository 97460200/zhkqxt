<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="code_imgnew05.aspx.cs" Inherits="RM.Web.SysSetBase.sales.code_imgnew05" %>
...
<body>
    ...
    <div id="EWM" class="checkewm checkewmnew clearfix"   style="width:597px;height:844px;padding-left:0;margin:0 auto;">
        <div id="zdyewm" class="checkewml" style="margin-right:0;width:595px">
            <div class="ewm" style="width: 595px; height: 842px;padding-left: 0;border:none;">
                <div class="zpyl" style="width: 595x;height:842px;margin-top:0;">
                    <div class="d2" style="width: 595px;height:842px;border:none;">
    ...
    <div style="text-align:center;margin-top:30px;">
        <a id="print" runat="server" href="javascript:printme()" class="btn"  target="_self" style="font-size: 12px;color: #c00;border: 1px solid #c00;">打印</a>
    </div>
