<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="code_imgnew03.aspx.cs"
    Inherits="RM.Web.SysSetBase.sales.code_imgnew03" %>
...
<body>
    ...
    <input runat="server" type="hidden" id="HdUser_ID" />
                ...
                <div style="position:relative;width: 540px;height: 540px;margin: 0 auto;">
                 <img  id="First_code"  runat="server"  style="width: 540px;height: 540px;">
                  <img  id="First_codes"  runat="server"  class="ewmzx1" style="top: 200px;left: 200px;width: 140px;height: 140px;position:absolute;border: 1px solid #fff;border-radius: 5px;">
                </div>
    </form>
</body>
</html>
