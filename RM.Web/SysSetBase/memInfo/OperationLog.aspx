<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperationLog.aspx.cs" Inherits="RM.Web.SysSetBase.memInfo.OperationLog" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ListGrid() {
            //url：请求地址
            var url = "mem.ashx?Menu=OperationLogList" + GetWhere();

            //colM：表头名称
            var colM = [
                { title: "主键编号", width: 50, align: "center", hidden: true },
                { title: "操作类型", width: 160, align: "center" },
                { title: "备注", width: 220, align: "center" },
                { title: "连接", width: 320, align: "center" },
                { title: "操作时间", width: 120, align: "center" }
            ];
