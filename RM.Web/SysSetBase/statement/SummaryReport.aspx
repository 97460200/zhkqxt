<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryReport.aspx.cs" Inherits="RM.Web.SysSetBase.statement.SummaryReport" %>
        ...
        <div class="shareframer">
            <div class="hzbb" id="bbmc">
                ...
                <div class="rge">
                 ...
                 <div class="bbgl" style="" id="Div1">
                <div class="d2 clearfix">
                <div class="d21">
                        客房营销数据
                    </div>                    
                    <div class="d22">
                        <span id="Span2">制表时间：2016-04-28 13:00</span><span class="dc">导出</span>
                    </div>
                </div>
                <div class="rge">
                    <div class="rgetable">
