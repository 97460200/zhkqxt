<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="businadminAdd.aspx.cs"
    Inherits="RM.Web.SysSetBase.superAdmin.businadminAdd" %>
...
<body>
    ...
    <dl class="adifoli adilen" style="width: 470px;">
        <dd>
            <small>酒店名称</small>
            <div>
                <select>
