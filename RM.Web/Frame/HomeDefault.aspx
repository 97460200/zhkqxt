<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeDefault.aspx.cs" Inherits="RM.Web.Frame.HomeDefault" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function editInfo() {
            ...
            top.openDialog(url, 'UserInfo_Info', '修改信息', 350, 310, 50, 50);

        }
        /**修改密码**/
        function editpwd() {
            var url = "/RMBase/SysUser/UpdateUserPwd.aspx";
            top.openDialog(url, 'UpdateUserPwd', '修改密码', 400, 270, 50, 50);
        }
        //新增快捷功能
                ...
                <dl>
                    ...
                    <dd class="last">
                        <span id="Email" runat="server" class="xg" style="display: ">woque@163.com</span><span
                            id="Theme" runat="server" style="display: " class="xg">13838383838</span><span class="xg"
