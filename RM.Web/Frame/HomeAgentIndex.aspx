<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeAgentIndex.aspx.cs" Inherits="RM.Web.Frame.HomeAgentIndex" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        /**修改用户信息**/
        function editInfo() {
            var url = "/RMAgentBase/SysUserAdmin/UserInfo_Edit.aspx";
            top.openDialog(url, 'UserInfo_Edit', '修改用户信息', 550, 270, 50, 50);
        }
        /**修改密码**/
        function editpwd() {
            var url = "/RMAgentBase/SysUserAdmin/UpdateUserPwd.aspx";
            top.openDialog(url, 'UpdateUserPwd', '修改登录密码', 400, 270, 50, 50);
        }
        //新增快捷功能
        function add_HomeShortcut() {
            var url = "/RMAgentBase/SysPersonal/HomeShortcut_Form.aspx";
        ...
        <div class="home_left">
            <div class="top boxshadow mode">
                <dl>
                    ...
                    <dd class="last">
                        <span id="Email" runat="server" class="xg" style="display: "></span>&nbsp;&nbsp;<span
