<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="RM.Web.Frame.login" %>
...
<head runat="server">
    ...
    <link href="/SysSetBase/css/backer.css?v=20190418" rel="stylesheet" type="text/css" />
...
//        }
    ...
    <script type="text/javascript">
        ...
        function GetQueryString(key) {
            ...
            var result = results.split(key)[1];
    ...
    <script type="text/javascript">
        ...
        function retrieve_pwd() {
            window.location.href = 'RetrievePwd.aspx';
        }
    </script>
</head>
<body class="newlogin">
    ...
    <div class="newloginc">
        <div class="newloginc-top">
            <p class="p1">
                <a href="/" target="_blank">
                    <img src="/SysSetBase/img/zdy.png" /></a>
            </p>
            <p class="p2">
                降低获单成本，提高服务品质
            </p>
        ...
        <div class="newloginc-center">
            ...
            <div class="biaodan dxdl" style="display: none;">
                ...
                <a id="dxdl_login" onclick="dxdl_login()" class="login">登 录 </a>
                <div class="caozuo">
                    <div onclick="retrieve_pwd()" class="wjmm">
                        忘记密码？
                    </div>
        ...
        <div class="newloginc-bottom">
            ...
            <div class="bah">
                © 2019 ZIDINN 智订云&nbsp;&nbsp;&nbsp; <a target="_blank" href="http://www.miitbeian.gov.cn/">
                    粤ICP备12091896号</a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $("input").on("input", function () {
            var mmdl_Name = $("#mmdl_Name").val();
            var mmdl_Pwd = $("#mmdl_Pwd").val();
            if (mmdl_Name != '' && mmdl_Pwd != '') {
                $("#mmdl_login").addClass("act");
            } else {
                $("#mmdl_login").removeClass("act");
            }
        });
        ...
        $("input").on("input", function () {
            var dxdl_Phone = $("#dxdl_Phone").val();
            var dxdl_Code = $("#dxdl_Code").val();
            if (dxdl_Phone != '' && dxdl_Code != '') {
                $("#dxdl_login").addClass("act");
            } else {
                $("#dxdl_login").removeClass("act");
            }
        });
