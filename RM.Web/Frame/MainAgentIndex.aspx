<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainAgentIndex.aspx.cs" Inherits="RM.Web.Frame.MainAgentIndex" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            Loading(true);
            iframeresize();
            AddTabMenu('ContentPannel', '/Frame/HomeAgentIndex.aspx', '系统首页', '', 'false');
        });
...
<body>
    ...
    <div id="Container">
        <div id="Header">
            <div style="margin-top: 23px; margin-left: 10px" id="HeaderLogo" onclick="AddTabMenu('ContentPannel', '/Frame/HomeAgentIndex.aspx', '系统首页', '', 'false');">
            </div>
                ...
                <div class="top">
                    <div class="right_title">
                        <ul>
                            ...
                            <li style="background: none;"><a class="li4" onclick="IndexOutss()">退出</a></li>
                        </ul>
                    </div>
