<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mem.aspx.cs" Inherits="RM.Web.AdminBase.SysSet.mem" %>
...
<body>
    ...
    <div class="gtrm">
        ...
        <iframe id="gtIfe" frameborder="0" width="100%" height="100%" src="" scrolling="no">
        </iframe>
    </div>
