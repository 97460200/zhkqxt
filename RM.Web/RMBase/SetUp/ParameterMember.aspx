<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParameterMember.aspx.cs"
    Inherits="RM.Web.RMBase.SetUp.ParameterMember" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            ifa.src = "/RMBase/SysParameter/Member1.aspx?AdminHotelid=" + AdminHotelid + "&Hotelid=" + Hotelid;
        });
        ...
        function GetTabClicks(val, type) {
            ...
            if (type == 1) {
                ...
                ifa.src = "/RMBase/SysParameter/Member3.aspx?AdminHotelid=" + AdminHotelid + "&Hotelid=" + Hotelid;
            }
            else if (type == 3) {
                ifa.src = "/RMBase/SysParameter/RechargeList.aspx?AdminHotelid=" + AdminHotelid + "&Hotelid=" + Hotelid;
            }
                                    ...
                                    <table style="padding: 0px; margin: 0px; height: 100%;" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td id="menutab" style="vertical-align: bottom;">
                                                <div id="tab0" class="Tabsel" onclick="GetTabClicks(this,1);">
                                                    <a target="iframe1" class="selected">会员注册设置</a></div>
                                                <div id="tab1" runat="server" class="Tabremovesel" onclick="GetTabClicks(this,2);">
                                                    <a target="iframe1">会员等级设置</a></div>
                                                <div id="Div1" runat="server" class="Tabremovesel" onclick="GetTabClicks(this,3);">
                                                    <a target="iframe1">会员充值设置</a></div>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
