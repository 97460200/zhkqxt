...
namespace RM.Web.RMBase.SysUser
{
    public partial class UpdateUserPwd : PageBase
    {
        ...
        {
            if (RequestSession.GetSessionUser().UserAccount != null)
                spUserName.InnerHtml = RequestSession.GetSessionUser().UserAccount.ToString();
            if (RequestSession.GetSessionUser().UserPwd != null)
