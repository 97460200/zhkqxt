...
{
    public partial class UserInfo_Edit : PageBase
    {
        ...
        private void InitData()
        {
            ...
            if (ht.Count > 0 && ht != null)
            {
                ...
                //string sqls = string.Format(@"select name from Hotel where 1=1 and id='{0}' order by sort asc", ht["hotelid".ToUpper()]);
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            bool IsOk = DataFactory.SqlDataBase().Submit_AddOrEdit("Base_UserInfo", "User_ID", RequestSession.GetSessionUser().UserId.ToString(), ht);
            if (IsOk)
            {
