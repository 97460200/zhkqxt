<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreRole_List.aspx.cs" Inherits="RM.Web.RMBase.SysUser.StoreRole_List" %>
    ...
    <script type="text/javascript">
        ...
        function ListGrid(load_bl) {
            ...
            var colM = [
                ...
                { title: "排序", width: 160, align: "center" },
                { title: "备注", width: 160, align: "center" },
                ...
                { title: "操作", editable: false, width: 120, align: "center", sortable: false,
                    render: function (ui) {
                        ...
                        px += "<span class='icon-lbx' onclick=\"DeleteById('" + rowData[0] + "')\">删除</span></div>";
                        return px;
                    }
                }
            ];
...
<body>
    ...
    <div class="tools_bar btnbartitle btnbartitlenr" style="display:block;">
        <div>
            当前位置：<span><a title="系统首页" href="/Frame/HomeIndex.aspx">系统首页</a></span><span> &gt; </span><span>系统管理</span> &gt; <span>角色管理</span>
        </div>
    </div>
