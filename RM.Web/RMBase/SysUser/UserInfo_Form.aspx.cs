    ...
    public partial class UserInfo_Form : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string sqls = string.Format(@"select id,name from Hotel where 1=1 and AdminHotelid='{0}' order by sort asc", HotelAdmin.Value);
        ...
        public void InitUserRight()
        {
            ...
            DataTable dtList = systemidao.GetMenuHtml(UserId);
