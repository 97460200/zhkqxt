<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo_Form.aspx.cs"
    Inherits="RM.Web.RMBase.SysUserAdmin.UserInfo_Form" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        div.Tabsel
        {
            background: #fff url(/Themes/images/bbgg.jpg) repeat-x 
            left top;
            border-bottom: 1px solid #fff;
        }
        ...
        #checkAllOn{background: url(/Themes/Images/checkAllOn2.png) no-repeat scroll 0 0;}
        ...
        function panel(obj) {
            if (obj == 1) {
                ...
                if (IsFixedTableLoad == 1) {
                    FixedTableHeader("#dnd-example", $(window).height() - 130);
                    IsFixedTableLoad = 0;
                }
            }
        }
            ...
            <tr>
                ...
                <td>
                    <input id="User_Name" runat="server" type="text" class="txt" datacol="yes" err="姓名"
                        checkexpession="NotNull" style="width: 138px; height: 21px;" />
                </td>
                <th>
                    性别
                </th>
