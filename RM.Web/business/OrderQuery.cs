...
namespace RM.Web.business
{
    public class OrderQuery
    {
        ...
        * @return 订单查询结果（xml格式）
        */
        public static string Run(string transaction_id, string out_trade_no, string AdminHotelid, int Hotelid)
        {
            ...
            WxPayData result = WxPayApi.OrderQuery(data, AdminHotelid, Hotelid);//提交订单查询请求给API，接收返回数据
