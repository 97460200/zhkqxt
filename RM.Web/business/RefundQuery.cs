...
namespace RM.Web.business
{
    public class RefundQuery
    {
        ...
        * @return 退款查询结果（xml格式）
        */
        public static string Run(string refund_id, string out_refund_no, string transaction_id, string out_trade_no, string AdminHotelid)
        {
            ...
            WxPayData result = WxPayApi.RefundQuery(data, AdminHotelid);//提交退款查询给API，接收返回数据
