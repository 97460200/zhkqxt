...
namespace RM.Web.business
{
    public class JsApiPay
    {
	    ...
	    */
         ...
         * @失败时抛异常WxPayException
         */
        public WxPayData GetUnifiedOrderResult(string AdminHotelid, string Setopenid, int Hotelid = 0)
        {
            if (!string.IsNullOrEmpty(Setopenid))
            {
                openid = Setopenid;
            }
            ...
            WxPayData result = WxPayApi.UnifiedOrder(data, AdminHotelid, Hotelid);//统一下单
            ...
            if (!result.IsSet("appid"))
            {
                ...
                Log.Error(this.GetType().ToString(), "appid参数错误!");
                throw new WxPayException("appid参数错误!");
            }
            if (!result.IsSet("prepay_id"))
            {
                Log.Error(this.GetType().ToString(), "prepay_id参数错误!");
                throw new WxPayException("prepay_id参数错误!");
            }
            if (result.GetValue("prepay_id").ToString() == "")
            {
                Log.Error(this.GetType().ToString(), "prepay_id参数为空!");
                throw new WxPayException("prepay_id参数为空!");
            }
        ...
        /// <param name="Setopenid"></param>
        /// <param name="Hotelid"></param>
        /// <returns></returns>
        public WxPayData Xcx_OrderResult(string AdminHotelid, string Setopenid, int Hotelid = 0)
        {
            if (!string.IsNullOrEmpty(Setopenid))
            {
                openid = Setopenid;
            ...
            WxPayData result = WxPayApi.Xcx_UnifiedOrder(data, AdminHotelid, Hotelid);//统一下单
        ...
        * 
        */
        public string GetJsApiParameters(string AdminHotelid, int Hotelid = 0)
        {

            WxPayData jsApiParam = new WxPayData();
            jsApiParam.SetValue("appId", unifiedOrderResult.GetValue("appid")); //WxPayConfig.APPID()); //unifiedOrderResult.GetValue("appid"));
            jsApiParam.SetValue("timeStamp", WxPayApi.GenerateTimeStamp());
            jsApiParam.SetValue("nonceStr", WxPayApi.GenerateNonceStr());
            jsApiParam.SetValue("package", "prepay_id=" + unifiedOrderResult.GetValue("prepay_id"));
            jsApiParam.SetValue("signType", "MD5");
            jsApiParam.SetValue("paySign", jsApiParam.MakeSign(AdminHotelid, Hotelid));
