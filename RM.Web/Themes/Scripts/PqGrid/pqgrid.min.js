(function (a) {
    ...
    a._regional = {
        ...
        strRefresh: "刷新",
        strRpp: "每页记录",
        strDisplay: "检索到 {2} 条记录，显示 第 {0}  -  {1} 条"
    };
    ...
    a._setSliderBgLength = function () {
        ...
        this.slider_length = 8 + 3 + 3 + 2 * g-20;
        if (this.direction == "vertical") {
    ...
    d._generateRow = function (r, q, x, I, y, n, F, B, j) {
        ...
        //pq-grid-row pq-row-select ui-state-highlight
    ...
    b._boundRow = function (m) {
        ...
        //$(j).find("div[name=checkbox]").attr("class","xuanxuanthis");
        if($(j).find("div[name=checkbox]").attr("class")=="xuanxuanthis")
        {
        $(j).find("div[name=checkbox]").attr("class","xuanxuanthis");
        }
        else
        {
        $(j).find("div[name=checkbox]").attr("class","xuanxuan");
    ...
    f._create = function () {
        ...
        this.$grid_inner = h("div.pq-grid-inner", this.element - 100);
    ...
    f._setInnerGridHeight = function () {
        ...
        this.$grid_inner.height(i - 42 + "px")
    };
    ...
    f._createHeader = function () {
        ...
        for (var t = 0; t < Q; t++) {
            ...
            if (t == 0 && this.numberCell) {
                I += "<td class='pq-grid-number-col' rowspan='" + Q + "'>				<div class='pq-grid-header-table-div' style='text-align: center;font-weight: bold;color: #666;'>序号</div></td>"
            }
            for (var s = 0; s < K; s++) {
                var n = L[t][s];
                var v = n.colSpan;
                ...
                if (n.title == "checkbox") {
                    I += "<td " + E + " " + C + " class='" + m + "' rowspan=" + n.rowSpan + " colspan=" + v + ">				<div class='pq-grid-header-table-div' ><div id='checkAllOff' onclick='CheckAllLine2(this)' class='xuanxuan2'></div></div></td>"
                } else {
    ...
    f._refreshHeaderSortIcons = function () {
        var i = this.options.dataModel;
        if (i.sortIndx == undefined || i.sortIndx == 0) {
            return
        }
