...
namespace RM.Busines.IDAO
{
    ...
    public interface RM_System_IDAO
    {
        ...
        /// </summary>
        /// <returns></returns>
        DataTable GetMenuBindA();
        /// <summary>
        /// 菜单所有列表
        /// </summary>
        /// <returns></returns>
        DataTable GetMenuBindAgent();
        /// <summary>
        /// 菜单树列表
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        DataTable GetMenuListA();
        /// <summary>
        /// 菜单树列表
        /// </summary>
        /// <returns></returns>
        DataTable GetMenuListAgent();
        /// <summary>
        /// 权限菜单导航
        /// </summary>
        ...
        /// <param name="UserId">用户主键</param>
        /// <returns></returns>
        DataTable GetMenuHtmlA(string UserId);
        /// <summary>
        /// 权限菜单导航
        /// </summary>
        /// <param name="UserId">用户主键</param>
        /// <returns></returns>
        DataTable GetMenuHtmlAgent(string UserId);
        /// <summary>
        /// 根据菜单主键获取已有按钮
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="iLength">需要多长就写多少个零,如4个长度 为"0000"</param>
        /// <returns></returns>
        string GetNumberByTableName(string tbName, string iLength);
