...
namespace RM.Common.DotNetJson
{
    ...
    public class JsonHelper
    {
        ...
        /// <param name="dt">table数据集</param>
        /// <param name="dtName">json名</param>
        /// <param name="UpperOrLower">转换大小写</param>
        /// <returns></returns>
        public static string DataTableToJson(DataTable dt, string dtName = "DataList", string UpperOrLower = "")
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("{\"");
            sb.Append(dtName);
        ...
        public static string DataRowToJson(DataRow dr)
        {
            ...
            foreach (DataColumn dc in dr.Table.Columns)
            {
                ...
                sb.Append(dc.ColumnName);
                sb.Append("\":\"");
                if (dr[dc] != null && dr[dc] != DBNull.Value && dr[dc].ToString().Trim() != "")
                {
                    if (dc.DataType == typeof(DateTime))
                    {
                        if (dr[dc] != null)
                        {
                            sb.Append(Convert.ToDateTime(dr[dc]).ToString("yyyy-MM-dd"));
                        }
                    }
                    else
                    {
