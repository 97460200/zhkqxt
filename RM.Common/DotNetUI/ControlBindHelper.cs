...
namespace RM.Common.DotNetUI
{
    ...
    public class ControlBindHelper
    {
        ...
        public static void SetDropDownListVal(DropDownList ddl, string val)
        {
            ...
            if (ht.Count != 0)
            {
                ...
                foreach (string key in ht.Keys)
                {
                    ...
                    if (control is DropDownList)
                    {
                        ...
                        if (txt.Items.FindByValue(val.ToString()) != null)
                    ...
                    {
                        HtmlGenericControl area = (HtmlGenericControl)control;
                        area.InnerHtml = val.ToString();
                    }
                }
            }
        }
